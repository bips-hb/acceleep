...
n_chunks <- 60        # Arbitrarily chosen, setting 120 results in 1 hour of simulated data
...
accel_train <- keras_reshape_accel(accel_sim_tbl[-1], interval_length, res)
dim(accel_train) # 50 * n_chunks

# Define labels (METs)
train_labels <- rnorm(n_chunks_total, 20, 10)
